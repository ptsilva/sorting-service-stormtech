 ...
 */
class AuthorSortStrategyTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers \App\Service\Strategy\AuthorSortStrategy::prepare
     */
    public function testPrepareMethodShouldMakeCallableSorter()
    {
        ...
        $authorSortStrategy = new AuthorSortStrategy($sortOrder, $comparator);
        $callable = $authorSortStrategy->prepare($inputValue);
    ...
    /**
     * @covers \App\Service\Strategy\AuthorSortStrategy::setNextSortStrategy
     * @covers \App\Service\Strategy\AuthorSortStrategy::nextSortStrategy
     */
    ...
    /**
     * @covers \App\Service\Strategy\AuthorSortStrategy::hasNextSortStrategy
     * @covers \App\Service\Strategy\AuthorSortStrategy::setNextSortStrategy
     */
    ...
    /**
     * @covers \App\Service\Strategy\AuthorSortStrategy::setComparator
     * @covers \App\Service\Strategy\AuthorSortStrategy::getComparator
     */
    ...
    public function testChainedSortStrategy()
    {
        ...
        ->shouldReceive('prepare')->andReturn(function ($firstItem, $secondItem) {
            return strcmp($firstItem['editionYear'], $secondItem['editionYear']) * -1; //Descending order
        })->mock();
